...
qui ogni batch attraversa discovery → schema → scrape → enrich → index: le posizioni degli
...
from phd_searcher.pipeline import discovery, enrich, index, schema_gen, scrape
